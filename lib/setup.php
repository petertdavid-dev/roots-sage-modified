...
function assets() {
    ...
    // wp_enqueue_style('googlefonts', 'https://fonts.googleapis.com/css?family=Arimo:400,400i,700,700i|Fredoka+One');

    wp_enqueue_script('modernizr', get_template_directory_uri() . '/assets/scripts/modernizr-custom.js', false, '9.30.16');
